...
public class OrderSummaryActivityTest {
    ...
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mActivityTestRule = new IntentsTestRule<>(OrderSummaryActivity.class);


    // OK (3) Finish this method which runs before each test and will stub all external
    ...
    // OK (4) Finish this method which verifies that the intent sent by clicking the send email
