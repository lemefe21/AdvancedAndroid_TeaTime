...
// OK (1) Implement ImageDownloader.DelayerCallback
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    // OK (2) Add a SimpleIdlingResource variable that will be null in production

    @Nullable
    private SimpleIdlingResource mIdlingResource;

    /**
     * OK (3) Create a method that returns the IdlingResource variable. It will
    ...
    /**
     * OK (4) Using the method you created, get the IdlingResource variable.
    ...
    // OK (5) Override onDone so when the thread in ImageDownloader is finished, it returns an
